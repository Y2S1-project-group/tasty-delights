                    ...
                    <div class="card" style="border-radius: 1rem;">
                        <div class="card-body p-5 text-center">
                            <div class="mb-md-5 mt-md-4 pb-5">
                                ...
                                <p class="small mb-5 pb-lg-2"><a class="" href="./customer-reset-password.jsp">Forgot password?</a></p>

                            </div>

                            <div>
                                <p class="mb-0">Don't have an account? <a href="./customer-register.jsp" class="fw-bold">Sign Up</a>
                            </div>
